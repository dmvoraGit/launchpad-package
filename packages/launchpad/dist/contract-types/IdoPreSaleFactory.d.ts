...
export type ContractContext = Web3ContractContext<IdoPreSaleFactory, IdoPreSaleFactoryMethodNames, IdoPreSaleFactoryEventsContext, IdoPreSaleFactoryEvents>;
export type IdoPreSaleFactoryEvents = 'IdoCreated' | 'OwnershipTransferred';
export interface IdoPreSaleFactoryEventsContext {
    IdoCreated(parameters: {
        filter?: {
            user?: string | string[];
            token?: string | string[];
...
export type IdoPreSaleFactoryMethodNames = 'new' | 'createIDO' | 'getDeployedIdos' | 'getIdoByToken' | 'owner' | 'postFeepc' | 'preFee' | 'renounceOwnership' | 'setFeeWallet' | 'setPostFee' | 'setPreFee' | 'transferOwnership' | 'uniswapRouter';
...
export interface IdoPreSaleFactory {
     ...
     */
    createIDO(_idopoolinfo: CreateIDORequest, raisetokenIn: string): MethodPayableReturnContext;
    /**
     * Payable: false
     * Constant: true
