...
export type ContractContext = Web3ContractContext<
  FairLaunch,
  FairLaunchMethodNames,
  FairLaunchEventsContext,
  FairLaunchEvents
>;
export type FairLaunchEvents =
  | 'AmountInvested'
  | 'AmountRefunded'
  | 'FLUpdated'
  | 'FairLaunchCanceled'
...
export interface FairLaunchEventsContext {
  ...
  FLUpdated(
    parameters: {
      filter?: { user?: string | string[]; buylimit?: string | string[] };
      fromBlock?: number;
      toBlock?: 'latest' | number;
      topics?: string[];
    },
...
export type FairLaunchMethodNames =
  | 'new'
  | 'buyTokens'
  | 'buyTokensWithNative'
  | 'cancelFairLaunch'
