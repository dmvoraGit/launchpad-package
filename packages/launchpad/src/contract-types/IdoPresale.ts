...
export type ContractContext = Web3ContractContext<
  IdoPresale,
  IdoPresaleMethodNames,
  IdoPresaleEventsContext,
  IdoPresaleEvents
>;
export type IdoPresaleEvents =
  | 'AmountRefunded'
  | 'IdoUpdated'
  | 'OwnershipTransferred'
  | 'RemoveFromWhitelisted'
  | 'TokenDeposited'
  | 'TokensClaimed'
  | 'Whitelisted';
...
export type IdoPresaleMethodNames =
  | 'new'
...
export interface IdoPresale {
   ...
   */
  'new'(
    _idopoolinfo: undefinedRequest,
    owner: string,
    _raisetokenin: string,
    _decimal: string | number,
    _feewallet: string,
    _postFeepc: string | number,
    _factory_admin: string,
  ...
  userRecord(
    parameter0: string
  ): MethodConstantReturnContext<UserRecordResponse>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
